...
var doctorContent = ['content1', 'content2', 'content3', 'content4'];
...
function show(i) {
	var index = i;
	console.log(index);
	$("#doctor_photo").attr("src", "img/doctor/" + index + ".jpg");
	$("#doctor_name").text(doctorName[i]);
	$("#doctor_content").text(doctorContent[i]);
	$(".users-dialog-bg").css("display", "flex");
}
